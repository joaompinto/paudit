...
Initial version based on:
    https://github.com/vstinner/python-ptrace/blob/master/strace.py
"""
...
class SyscallTracer(Application):
    ...
    def parseOptions(self):
        ...
        parser.add_option(
            "--profiler", help="Use profiler", action="store_true", default=False
        )
        parser.add_option(
            "--type",
        ...
        parser.add_option(
            "--output", "-o", help="Write output to specified log file", type="str"
        )
        parser.add_option(
            "--ignore-regex",
            help="Regex used to filter syscall names (e.g. --ignore='^(gettimeofday|futex|f?stat)')",
            type="str",
        )
        parser.add_option(
            "--address",
        ...
        parser.add_option(
            "--syscalls",
            "-e",
            help="Comma separated list of shown system calls (other will be skipped)",
            type="str",
            default=None,
        )
        parser.add_option(
